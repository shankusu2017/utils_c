...
int main(char *argv[], int argc) {
    timer_init();
    timer_add(1, 1, timeout1, NULL);

    timer_add(1000, 1, timeout1000, NULL);
    timer_add(1001, 1, timeout1001, NULL);
    timer_add(1500, 1, timeout1500, NULL);

    timer_add(60000, 1, timeout60000, NULL);
    timer_add(60001, 1, timeout60001, NULL);
    timer_add(90000, 1, timeout90000, NULL);

    while(1) {
        utils_msleep(1000*60);
    }
}
